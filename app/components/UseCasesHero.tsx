  ...
  return (
    <section ref={heroRef} className="relative pt-32 pb-20 overflow-hidden">
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="usecases-hero-content text-center">
          ...
          <p className="text-xl text-[var(--color-muted-ink)] max-w-3xl mx-auto leading-relaxed">
            Whether you're a designer, developer, consultant, or agency —
            EchoHub adapts to how you work.
          </p>
        </div>
      </div>
    </section>
